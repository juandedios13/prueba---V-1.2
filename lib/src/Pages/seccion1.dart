...
class DataWorkOne extends StatefulWidget {
  final _idtrabajo;
  final String _correo;
  final String _datos;

  DataWorkOne(this._idtrabajo, this._correo, this._datos);

  @override
  _DataWorkOneState createState() => _DataWorkOneState();
}

class _DataWorkOneState extends State<DataWorkOne> {
                    ...
                    Padding(
                      ...
                      child: Column(children: [
                        Padding(
                          ...
                          child: Text("Humeda relativa:                   ",
                              style: TextStyle(height: 1, fontSize: 16)),
                        ),
                        Container(
                          width: 200,
                          height: 45,
                          child: SizedBox(width: 100, child: _inputHumedad()),
                        ),
                        Divider(),
                        Padding(
                          padding: const EdgeInsets.only(bottom: 5),
                        ...
                        Container(
                          ...
                          height: 45,
                          child: SizedBox(
                              width: 100, child: _inputTempAmbiental()),
                        ),
                      ]),
                    ),
                    Container(
  ...
  _inputRugosidad() {
    return TextField(
      ...
      onChanged: (e) {
        ...
        setState(() => {_rugosidad = double.parse(e), _mensaje = Container()});
      },
    );
  }
  ...
  Future _enviardatos() async {
    ...
    try {
      ...
      var url = Uri.parse("http://192.168.1.11:3000/seccion1");
